/* CHATGPT_LAYER_REMOTE */

(() => {
  "use strict";

  if (globalThis.__CHATGPT_LAYER_REMOTE_STARTED__) return;
  globalThis.__CHATGPT_LAYER_REMOTE_STARTED__ = true;

  const REMOTE_VERSION = "2026-07-27.1";
  ...
  function installButton() {
    ...
    if (!button) {
      ...
      button.dataset.layerVersion = REMOTE_VERSION;
