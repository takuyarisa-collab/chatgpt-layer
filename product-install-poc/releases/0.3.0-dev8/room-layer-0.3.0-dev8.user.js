...
(function () {
  ...
  __modules["src/features/wood-desk.js"] = (() => {
    ...
    function createWoodDeskController({
      document,
      ...
      function apply(composer) {
        ...
        if (validExisting) {
          ...
          observeStructure(existingSurface, existingMat, composer);
          return {
        ...
        observeStructure(surface, mat, composer);
      ...
      function observeStructure(surface, mat, composer) {
        if (!resizeObserver) return;
        resizeObserver.disconnect();
        for (const element of [surface, mat, composer]) {
  ...
  __modules["src/features/composer-background.js"] = (() => {
    ...
    function createComposerBackgroundFeature({
      ...
      const woodDesk = createWoodDeskController({
        document,
        ResizeObserver,
        onLayoutChange: () => {
          if (resizeRefreshQueued || !activeColor) return;
  ...
  __modules["src/product-identity.js"] = (() => {
    ...
    const DEVELOPMENT_VERSION = "0.3.0-dev8";
