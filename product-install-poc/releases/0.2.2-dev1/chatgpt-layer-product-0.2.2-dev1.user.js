...
// @version      0.2.2-dev1
// @description  Scoped themes with quick scroll, reload, and draggable settings controls.
// @author       TaC & Shion
...
(function () {
  ...
  __modules["src/i18n/messages.js"] = (() => {
    ...
    const MESSAGES = Object.freeze({
      ...
      ja: Object.freeze({
        ...
        "action.import": "インポート",
        "action.reset": "リセット",
        "action.resetLauncher": "ボタン位置を初期化",
    ...
    function createUiPreferencesStore({ backend }) {
      ...
      async function loadLauncherPosition() {
        ...
        try {
          ...
          if (value?.version !== 1) return DEFAULT_LAUNCHER_POSITION;
          return normalizeLauncherPosition(value.launcher);
        } catch {
          return DEFAULT_LAUNCHER_POSITION;
        }
      }
      ...
      async function saveLauncherPosition(position) {
        ...
        await backend.set(UI_PREFERENCES_KEY, JSON.stringify({
          version: 1,
          launcher
        }));
        return launcher;
  ...
  __modules["src/ui/settings-panel.js"] = (() => {
    ...
    function createSettingsPanel({
      ...
      function renderEditor() {
        ...
        const launcherField = element(document, "section", "launcherField");
  ...
  __modules["src/ui/utility-actions.js"] = (() => {
    ...
    function createUtilityActions({
      ...
      return Object.freeze({ host, render, destroy });
    }
  ...
  __modules["src/userscript/main.js"] = (() => {
    ...
    async function bootstrap() {
      ...
      const [loadResult, launcherPosition] = await Promise.all([
        store.load(),
      ...
      async function resetFromPanel() {
        const [resetSettings, resetPosition] = await Promise.all([
          store.reset(),
          uiPreferences.resetLauncherPosition()
        ]);
        ...
        panel.setLauncherPosition(resetPosition);
        applyCurrentTheme();
        renderPanel();
