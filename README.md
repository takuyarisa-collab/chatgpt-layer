...
会話、履歴、推論、ChatGPT Plusの利用枠はChatGPT側に残し、画面上の見た目、ボタン、入力補助だけを追加します。
...
<html
  ...
  data-chatgpt-layer-config-version="2026-08-01.1"
>
```
...
固定エンジンを0.9.0へ更新した後は、レイヤー固有ボタンの追加・変更はJSON更新とページ再読み込みだけで反映できます。

## Update flow

### プロジェクト、チャット、テーマ、アクションの追加・変更
